...
namespace Snake
{
    public class FullSnake
    {
        ...
        public void RenderSnake(PictureBox gameBoardPictureBox)
        {
            ...
            {
                MyGraphics.FillEllipse(MyBrush2, new Rectangle(_Snake[_Snake.Count - 1].Get_X(), _Snake[_Snake.Count - 1].Get_Y() + (gameBoardPictureBox.Width / 54), (gameBoardPictureBox.Width / 54 - 2), (gameBoardPictureBox.Width / 54 - 2))); // Recolor below the last part of snake.
            ...
            {
                MyGraphics.FillEllipse(MyBrush2, new Rectangle(_Snake[_Snake.Count - 1].Get_X() - (gameBoardPictureBox.Width / 54), _Snake[_Snake.Count - 1].Get_Y(), (gameBoardPictureBox.Width / 54 - 2), (gameBoardPictureBox.Width / 54 - 2))); // Recolor at the left of the last part of snake.
            ...
            {
                MyGraphics.FillEllipse(MyBrush2, new Rectangle(_Snake[_Snake.Count - 1].Get_X(), _Snake[_Snake.Count - 1].Get_Y() - (gameBoardPictureBox.Width / 54), (gameBoardPictureBox.Width / 54 - 2), (gameBoardPictureBox.Width / 54 - 2))); // Recolor above the last part of snake.
            ...
            {
                MyGraphics.FillEllipse(MyBrush2, new Rectangle(_Snake[_Snake.Count - 1].Get_X() + (gameBoardPictureBox.Width / 54), _Snake[_Snake.Count - 1].Get_Y(), (gameBoardPictureBox.Width / 54 - 2), (gameBoardPictureBox.Width / 54 - 2))); // Recolor at the right of the last part of snake.
